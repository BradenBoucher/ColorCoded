...
enum OfflineScoreColorizer {
    ...
    private static func buildStrokeCleanedImage(baseImage: PlatformImage,
        ...
        await buildStrokeCleanedImageInternal(baseImage: baseImage, staffModel: staffModel, systems: systems)
    }

    private static func buildStrokeCleanedImageInternal(baseImage: PlatformImage,
                                                        staffModel: StaffModel?,
                                                        systems: [SystemBlock]) async -> StrokeCleanResult? {
        ...
        return buildStrokeCleanedImageInternal(
            cgImage: cg,
            spacing: spacing,
            systems: systems,
    ...
    private static func buildStrokeCleanedImageInternal(cgImage: CGImage,
                                                        spacing: CGFloat,
                                                        systems: [SystemBlock],
